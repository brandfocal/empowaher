...
export function ContactPage() {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <section
        className="relative flex min-h-[65vh] items-end bg-[#1C2128] text-white md:min-h-[75vh] lg:min-h-[85vh]"
        style={{
          backgroundImage:
            "linear-gradient(to top, rgba(28,33,40,.97) 0%, rgba(28,33,40,.62) 45%, rgba(28,33,40,.12) 100%), url('https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=1600&q=80')",
          backgroundPosition: "center",
          backgroundSize: "cover",
        }}
        aria-labelledby="hero-heading"
      >
        <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/55 to-black/20" aria-hidden="true" />

        <div className="relative z-10 mx-auto grid w-full max-w-7xl grid-cols-1 items-end gap-8 px-4 pb-12 pt-28 md:grid-cols-[6fr_3fr] md:gap-10 md:px-6 md:pb-16 lg:grid-cols-[6fr_3fr_3fr] lg:gap-16 lg:px-12 lg:pb-20">
          <div className="lg:border-r lg:border-white/15 lg:pr-10">
            {/* Status Badge Eyebrow */}
            <div
              className="hero-reveal mb-5 flex max-w-full flex-wrap items-center gap-2 rounded-full border border-white/30 bg-white/10 px-3.5 py-1.5 text-[0.625rem] font-bold uppercase tracking-[0.14em] text-white backdrop-blur-sm sm:px-4 sm:text-[0.6875rem]"
            ...
            {/* Summit Overline */}
            <div
              className="hero-reveal mb-4 flex flex-wrap items-center gap-2 text-[0.6875rem] font-bold uppercase tracking-[0.16em] text-white/85 sm:text-xs lg:tracking-[0.2em]"
            ...
            <h1
              id="hero-heading"
              className="font-heading text-[clamp(2.8rem,6vw,5.5rem)] font-black uppercase leading-[0.92] tracking-[-0.03em] text-white"
            >
              <span>START A</span>
              <br />
          ...
          <div className="hidden md:block md:border-r md:border-white/15 md:pr-8 lg:pr-10">
            <p className="text-[0.6875rem] font-black uppercase tracking-[0.2em] text-white/60">
              <span>29–31 October 2026</span>
            </p>
            <p className="mt-4 max-w-[18ch] text-[0.6875rem] font-black uppercase leading-relaxed tracking-[0.2em] text-white/60">
      ...
      <section id="about" className="border-t-[6px] border-[#ed027e] bg-white" aria-labelledby="about-heading">
        <div className="bg-[#1C2128] px-4 py-16 text-white md:px-6 md:py-20 lg:px-12 lg:py-24">
          <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 md:flex-row md:items-end md:gap-10 lg:gap-16">
            <div>
              <p className="border-l-2 border-[#ed027e] pl-3 text-[0.62rem] font-black uppercase tracking-[0.3em] text-[#ed027e]">
                <span>PRODUCED BY EMPOWAWORX™</span>
              </p>
              <h2
                id="about-heading"
                className="font-heading mt-4 max-w-[16ch] text-[clamp(2rem,4.5vw,3.75rem)] font-black uppercase leading-[0.92] tracking-[-0.03em] text-white"
              >
        ...
        {/* 3-Column Detailed Contact Cards */}
        <div className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-20 lg:px-12 lg:py-24">
          <div className="grid grid-cols-1 gap-8 border-t border-[#1C2128]/10 pt-10 md:grid-cols-2 md:gap-10 lg:grid-cols-3">
            ...
            <article className="min-w-0">
              <p className="text-[0.62rem] font-black uppercase tracking-[0.25em] text-[#ed027e]">
                <span>01 — EXECUTIVE OFFICE</span>
              </p>
              <h3 className="font-heading mt-4 text-[clamp(1.4rem,2.5vw,2rem)] font-black uppercase leading-[1] tracking-[-0.03em] text-[#1C2128]">
      ...
      <section
        id="contact"
        className="border-t-[6px] border-[#ed027e] bg-[#1C2128] px-4 py-16 text-white md:px-6 md:py-20 lg:px-12 lg:py-28"
        aria-labelledby="form-heading"
      >
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-20">
          <div className="lg:sticky lg:top-28">
            <p className="mb-5 border-l-2 border-[#ed027e] pl-3 text-[0.62rem] font-black uppercase tracking-[0.25em] text-[#ed027e]">
              <span>SEND A MESSAGE</span>
            </p>
            <h2
              id="form-heading"
              className="font-heading max-w-[10ch] text-[clamp(2.5rem,5vw,5rem)] font-black uppercase leading-[0.88] tracking-[-0.04em] text-white"
            >
